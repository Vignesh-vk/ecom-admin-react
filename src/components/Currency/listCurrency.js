        ...
        if (Currency == 0) {
            ...
            for (var i = 0; i < Currency.length; i++) {
                ...
                resultArray.push(<tr key={i} >
                    ...
                    <td>{tempVal}</td>
                    <td>
                        <button type="button" id={Currency[i]._id} onClick={this.viewCurrency} class="btn btn-success">View</button>
                        <button type="button" id={Currency[i]._id} onClick={this.editCurrency} class="btn btn-success">Edit</button>
                        <button type="button" id={Currency[i]._id} onClick={this.delete} class="btn btn-danger">delete</button>
                    </td>
                </tr>)
            }
        }
