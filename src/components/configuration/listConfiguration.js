        ...
        if (Config == 0) {
            ...
            for (var i = 0; i < Config.length; i++) {
                ...
                resultArray.push(<tr key={i} >
                    ...
                    <td>{tempVal}</td>
                    <td>
                        <button type="button" id={Config[i]._id} onClick={this.viewConfig} class="btn btn-success">View</button>
                        <button type="button" id={Config[i]._id} onClick={this.editConfig} class="btn btn-success">Edit</button>
                        <button type="button" id={Config[i]._id} onClick={this.delete} class="btn btn-danger">delete</button>
                    </td>
                </tr>)
            }
        }
