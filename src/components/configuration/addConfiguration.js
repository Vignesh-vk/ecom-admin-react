            ...
            <div class="card-body">
              <form class="forms-sample">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Configuration" id="name" value={this.state.name} onChange={this.handleInputChange} class="form-control" ></input>
                  {this.state.nameError ? <label class="mt-2" style={{ color: 'red' }}>Configuration is required</label> : ""}
                </div>
                <div class="form-group">
                  <h4 style={{ fontSize: '0.875rem' }}>Slug</h4>
                  <input type="text" placeholder="Slug" id="slug" value={this.state.slug} onChange={this.handleInputChange} class="form-control" ></input>
                  {this.state.slugError ? <label class="mt-2" style={{ color: 'red' }}>Slug is required</label> : ""}
                </div>
                <div class="form-group">
                  <h4 style={{ fontSize: '0.875rem' }}>Description</h4>
                  <input type="text" placeholder="Description" id="description" value={this.state.description} onChange={this.handleInputChange} class="form-control" ></input>
