        ...
        if (Country == 0) {
            ...
            for (var i = 0; i < Country.length; i++) {
                ...
                resultArray.push(<tr key={i} >
                    ...
                    <td>{tempVal}</td>
                    <td>
                        <button type="button" id={Country[i]._id} onClick={this.viewCountry} class="btn btn-success">View</button>
                        <button type="button" id={Country[i]._id} onClick={this.editCountry} class="btn btn-success">Edit</button>
